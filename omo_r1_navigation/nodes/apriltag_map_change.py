        ...
        if data.detections:
            ...
            if(tag_id==6):
                if flag==0:
                    ...
                    roslaunch_command = "roslaunch omo_r1_navigation omo_r1_navigation_G2.launch map_file:='/home/minjeong/catkin_ws/src/omo_r1_navigation/maps/floor6.yaml'"
                    try:
                ...
                if flag==1:
                    self.kill_ros_node('/robot_state_publisher')
                    self.kill_ros_node('/map_server')
                    roslaunch_command = "roslaunch omo_r1_navigation omo_r1_navigation_G2.launch map_file:='/home/minjeong/catkin_ws/src/omo_r1_navigation/maps/floor3.yaml'"
                    try:
                        subprocess.Popen(roslaunch_command, shell=True)
                        flag=2
                    except Exception as e:
